...
export function HouseholdDashboard() {
  ...
  return <main className="app-shell">
    <header className="topbar"><div><span className="badge">Sprint 2</span><h1>Minha Casa</h1><p>Estoque e planejamento da próxima compra em um só lugar.</p></div><button className="button secondary" onClick={signOut}>Sair</button></header>
