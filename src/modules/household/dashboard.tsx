...
export function HouseholdDashboard() {
  ...
  return <main className="app-shell">
    <header className="topbar"><div><span className="badge">Sprint 5</span><h1>Minha Casa</h1><p>Estoque, recomendações, planejamento, preços e compras em um só lugar.</p></div><div className="topbar-actions">{householdId && <Tutorial storageScope={householdId} autoOpen={products.length === 0} compact />}<button className="button secondary" onClick={signOut}>Sair</button></div></header>
